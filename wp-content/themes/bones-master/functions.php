...
//Plugins
*/
//require_once("library/insta-gallery.php");
//require_once("library/new-insta-gallery.php");

/**
// Widgets
*/
require_once("widgets/easy-image-widget.php");
require_once("widgets/posts-carousel-widget.php");
require_once("widgets/instush-widget.php");
...
// Thumbnail sizes
add_image_size( 'bones-full'); 
add_image_size( 'bones-1920', 1920 ); 
add_image_size( 'bones-thumb-700', 800);
add_image_size( 'bones-thumb-300', 300);
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        'bones-thumb-700' => __('800px by 400px'),
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'sidebar-top-full',
		'name' => __( 'Sidebar Top Full Width', 'bonestheme' ),
		'description' => __( 'The first (primary) sidebar.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle"><span>',
